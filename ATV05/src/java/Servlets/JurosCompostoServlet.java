    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           int D = Integer.parseInt(Dt);
            ...
            out.println("<title>Servlet JurosCompostoServelt</title>"); 
             out.println(" <h2>João Vitor Lourenço da Silva/ RA: 1290482022015 </h2>\n" + "<br>" +
"        \n" + "<h2> Matheus Meduneckas Pires da Silva / RA: 1290482022022 </h2> " +
"        <br><hr><br>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet JurosCompostoServelt</h1>"); 
